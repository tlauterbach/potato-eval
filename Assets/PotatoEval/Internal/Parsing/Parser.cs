...
namespace PotatoEval {
	...
	internal class Parser : IParser {
		...
		private static readonly Dictionary<TokenType, IPrefixParselet> m_prefixParselets = new Dictionary<TokenType, IPrefixParselet>() {
			...
			{ TokenType.Ampersand,  new PrefixOpParselet(BindingPower.Unary, OpCode.IdOf) },
		};
		private static readonly Dictionary<TokenType, IInfixParselet> m_infixParselets = new Dictionary<TokenType, IInfixParselet>() {
			...
			{ TokenType.Period,				new AccessOpParselet(BindingPower.Postfix) },
			...
			{ TokenType.LessThan,			new InfixOpParselet(BindingPower.Relational, OpCode.LessThan) },
			...
			{ TokenType.Modulo,				new InfixOpParselet(BindingPower.Multiplicative, OpCode.Modulo) },
