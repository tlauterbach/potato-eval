...
namespace PotatoEval {
	...
	internal class Lexer : ICharStream {
		...
		private readonly List<IPattern> m_patterns = new List<IPattern>() {
			...
			new PatternSymbol(TokenType.LeftLeftEqual,		"<<="),
			new PatternSymbol(TokenType.RightRightEqual,	">>="),
			new PatternSymbol(TokenType.RightEqual,			">="),
			new PatternSymbol(TokenType.LeftEqual,			"<="),
			new PatternSymbol(TokenType.PlusEqual,			"+="),
			new PatternSymbol(TokenType.MinusEqual,			"-="),
			new PatternSymbol(TokenType.StarEqual,			"*="),
			new PatternSymbol(TokenType.SlashEqual,			"/="),
			new PatternSymbol(TokenType.PercentEqual,		"%="),
			new PatternSymbol(TokenType.AmpersandEqual,		"&="),
			new PatternSymbol(TokenType.PipeEqual,			"|="),
			new PatternSymbol(TokenType.CarretEqual,		"^="),
			...
			new PatternSymbol(TokenType.Equal,				"="),
